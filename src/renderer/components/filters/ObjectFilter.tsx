...
export class ObjectFilterQuery {
  constructor(public property: string, public searchValue: string) {}
}

interface ObjectFilterProps {
  filters: ObjectFilterQuery[];
  setFilters: Dispatch<SetStateAction<ObjectFilterQuery[]>>;
}
...
export default function ObjectFilter({
  ...
  const [newFilter, setNewFilter] = useState(new ObjectFilterQuery('', ''));
