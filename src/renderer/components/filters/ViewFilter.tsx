...
export class ViewFilterQuery {
  constructor(public property: string, public searchValue: string) {}
}

interface ViewFilterProps {
  filters: ViewFilterQuery[];
  setFilters: Dispatch<SetStateAction<ViewFilterQuery[]>>;
}
...
export default function ViewFilter({ filters, setFilters }: ViewFilterProps) {
  const [newFilterOpen, setNewFilterOpen] = useState(false);
  const [newFilter, setNewFilter] = useState(new ViewFilterQuery('', ''));
